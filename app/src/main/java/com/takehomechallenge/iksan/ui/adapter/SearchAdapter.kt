...
import com.takehomechallenge.iksan.databinding.ItemCharacterSearchBinding
import com.takehomechallenge.iksan.ui.activity.DetailsActivity

class SearchAdapter:
    PagingDataAdapter<CharacterItem, SearchAdapter.ViewHolder>(DIFF_CALLBACK) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemCharacterSearchBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class ViewHolder(private val binding: ItemCharacterSearchBinding) :
